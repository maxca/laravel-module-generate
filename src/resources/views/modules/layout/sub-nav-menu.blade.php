<ol class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="http://localhost:8814/admin/dashboard">Dashboard</a></li>
    ...
    <li class="breadcrumb-menu">
        <div class="btn-group" role="group" aria-label="Button group">
            <div class="dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="breadcrumb-dropdown-1" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(0px, 21px, 0px);">
